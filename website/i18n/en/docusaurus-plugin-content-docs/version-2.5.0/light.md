...
Smooth blinking can be performed by writing data with the following structure.

| Data location | Type  | Content                         | Example                                                   |
| ------------- | ----- | ------------------------------- | --------------------------------------------------------- |
| 0             | UInt8 | Control type                    | <span class="fixed">`0x70`</span> (Smooth blinking)       |
| 1             | UInt8 | Number of blinks                | `0x00` (Infinite)                                         |
| 2             | UInt8 | Number of indicators controlled | <span class="fixed">`0x01`</span>                         |
| 3             | UInt8 | ID of the indicator controlled  | <span class="fixed">`0x01`</span>                         |
| 4             | UInt8 | Blinking cycle                  | `0x0a` (100 milliseconds)                                 |
| 5             | UInt8 | Value for red indicator         | `0xFF`                                                    |
| 6             | UInt8 | Value for green indicator       | `0xFF`                                                    |
| 7             | UInt8 | Value for blue indicator        | `0xFF`                                                    |

#### Number of blinks

Sets the number of blinks.

| Number of blinks          | Meaning                              |
| ------------------------- | ------------------------------------ |
| `0x00`                    | Infinite                            |
| `0x01` through `0xff`     | Blinks the specified number of times |

#### Blinking cycle

Sets the cycle time from smoothly turning on to smoothly turning off.

| Blinking cycle            | Meaning                                        |
| ------------------------- | ---------------------------------------------- |
| `0x00` through `0x09`     | Invalid setting                                |
| `0x0a` through `0xff`     | Blinks at the specified cycle x 10 milliseconds |
