...
The 3D model data are licensed under the [Creative Commons Attribution-NoDerivatives 4.0 International Public License](https://creativecommons.org/licenses/by-nd/4.0/). Please check [here](about.md#license) for details.

:::

## Protruding shapes for block attachment <span class="update"/>
